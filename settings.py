...
def setup():
    ...
    days_range = int(getenv("GDAYS_RANGE")) or 40
    ...
    calendar = GCalendar(
        ...
        credentials_path=gcredentials_path,
        pickle_path=token_pickle_path,
        timezone=timezone,
    )

    return inbox_col, projects_col, tasks_col, get_block, calendar, days_range
